...
<section class="produktkort-grid">
  <article class="produktkort">
    <img src="{{ '/bilder/babyskydd.svg' | version }}" alt="Bakåtvänt babyskydd i genomskärning, med bärhandtag och internbälte" loading="lazy" width="360" height="300">
    <h3>Babyskydd</h3>
  ...
  <article class="produktkort">
    <img src="{{ '/bilder/bakatvand.svg' | version }}" alt="Bakåtvänd bilbarnstol med hög rygg och stödben mot golvet" loading="lazy" width="360" height="300">
  ...
  <article class="produktkort">
    <img src="{{ '/bilder/framatvand.svg' | version }}" alt="Framåtvänd bältesstol där bilbältet går diagonalt över barnets bröst" loading="lazy" width="360" height="300">
